...
const App = {
    ...
    toolConfig: [
        ...
        { key: 'returnedmail', icon: '📬', color: 'icon-red',   title: 'Returned Mail',   name: 'Returned Mail Tracker',  containerId: 'returnedMailTool', initModule: 'ReturnedMailTracker', htmlFile: 'plugins/returned-mail.html', category: 'ops' },
        // ┌────────────────────────────────────────────────────────────┐
        // │  ADD NEW TOOLS HERE                                        │
