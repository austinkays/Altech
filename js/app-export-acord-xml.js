...
Object.assign(App, {
    ...
    buildEZLynxXML() {
        ...
        const fileName = `EZLynx_Import_${App._safeFileNamePart(data.lastName, 'Client')}_${new Date().toISOString().split('T')[0]}.xml`;
    ...
    buildEZLynxHomeXML() {
        ...
        const fileName = `EZLynx_Home_Import_${App._safeFileNamePart(data.lastName, 'Client')}_${new Date().toISOString().split('T')[0]}.xml`;
        return { content: xml, filename: fileName, mime: 'application/xml;charset=utf-8' };
    },
});
