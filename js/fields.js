...
window.FIELDS = [
    ...
    { id: 'firstName',      label: 'First Name',        type: 'text',    section: 'applicant' },
    ...
    { id: 'lastName',       label: 'Last Name',         type: 'text',    section: 'applicant' },
    { id: 'suffix',         label: 'Suffix',            type: 'select',  section: 'applicant' },
    { id: 'dob',            label: 'Date of Birth',     type: 'date',    section: 'applicant' },
    { id: 'gender',         label: 'Gender',            type: 'select',  section: 'applicant' },
    { id: 'maritalStatus',  label: 'Marital Status',    type: 'select',  section: 'applicant' },
    { id: 'phone',          label: 'Phone',             type: 'tel',     section: 'applicant' },
    { id: 'email',          label: 'Email',             type: 'email',   section: 'applicant' },
    { id: 'education',      label: 'Education',         type: 'select',  section: 'applicant' },
    { id: 'industry',       label: 'Industry',          type: 'select',  section: 'applicant' },
    { id: 'occupation',     label: 'Occupation',        type: 'text',    section: 'applicant' },

    // ── Co-Applicant ───────────────────────────────────────────────────────
    { id: 'coFirstName',    label: 'Co-App First Name', type: 'text',    section: 'coapplicant' },
    { id: 'coLastName',     label: 'Co-App Last Name',  type: 'text',    section: 'coapplicant' },
    { id: 'coDob',          label: 'Co-App DOB',        type: 'date',    section: 'coapplicant' },
    { id: 'coGender',       label: 'Co-App Gender',     type: 'select',  section: 'coapplicant' },
    { id: 'coEmail',        label: 'Co-App Email',      type: 'email',   section: 'coapplicant' },
    { id: 'coPhone',        label: 'Co-App Phone',      type: 'tel',     section: 'coapplicant' },
    { id: 'coRelationship', label: 'Relationship',      type: 'select',  section: 'coapplicant' },
    { id: 'coOccupation',   label: 'Co-App Occupation', type: 'text',    section: 'coapplicant' },
    { id: 'coEducation',    label: 'Co-App Education',  type: 'select',  section: 'coapplicant' },
    { id: 'coIndustry',     label: 'Co-App Industry',   type: 'select',  section: 'coapplicant' },

    // ── Address ────────────────────────────────────────────────────────────
    // NOTE: field IDs are addrStreet/addrCity/addrState/addrZip — NOT address/city/state/zip
    { id: 'addrStreet',       label: 'Street Address',       type: 'text',   section: 'address' },
    { id: 'addrCity',         label: 'City',                 type: 'text',   section: 'address' },
    { id: 'addrState',        label: 'State',                type: 'select', section: 'address' },
    { id: 'addrZip',          label: 'ZIP Code',             type: 'text',   section: 'address' },
    ...
    // ── Property ───────────────────────────────────────────────────────────
    { id: 'yrBuilt',          label: 'Year Built',           type: 'number', section: 'property' },
    { id: 'sqFt',             label: 'Square Footage',       type: 'number', section: 'property' },
    { id: 'lotSize',          label: 'Lot Size',             type: 'text',   section: 'property' },
    { id: 'dwellingType',     label: 'Dwelling Type',        type: 'select', section: 'property' },
    { id: 'dwellingUsage',    label: 'Dwelling Usage',       type: 'select', section: 'property' },
    { id: 'occupancyType',    label: 'Occupancy',            type: 'select', section: 'property' },
    { id: 'numStories',       label: 'Stories',              type: 'select', section: 'property' },
    { id: 'numOccupants',     label: 'Occupants',            type: 'number', section: 'property' },
    { id: 'bedrooms',         label: 'Bedrooms',             type: 'select', section: 'property' },
    { id: 'fullBaths',        label: 'Full Baths',           type: 'select', section: 'property' },
    { id: 'halfBaths',        label: 'Half Baths',           type: 'select', section: 'property' },
    { id: 'constructionStyle',label: 'Construction',         type: 'select', section: 'property' },
    { id: 'exteriorWalls',    label: 'Exterior Walls',       type: 'select', section: 'property' },
    { id: 'foundation',       label: 'Foundation',           type: 'select', section: 'property' },
    ...
    { id: 'purchaseDate',     label: 'Purchase Date',        type: 'date',   section: 'property' },

    // ── Roof ───────────────────────────────────────────────────────────────
    { id: 'roofType',   label: 'Roof Type',        type: 'select', section: 'roof' },
    { id: 'roofShape',  label: 'Roof Shape',       type: 'select', section: 'roof' },
    { id: 'roofYr',     label: 'Roof Year',        type: 'number', section: 'roof' },
    { id: 'roofUpdate', label: 'Roof Update Type', type: 'select', section: 'roof' }, // PDF only — not in HawkSoft FSC

    // ── Systems ────────────────────────────────────────────────────────────
    { id: 'heatingType',  label: 'Heating Type',       type: 'select', section: 'systems' },
    { id: 'heatYr',       label: 'Heating Updated',    type: 'number', section: 'systems' },
    { id: 'cooling',      label: 'Cooling',            type: 'select', section: 'systems' },
    { id: 'plumbYr',      label: 'Plumbing Updated',   type: 'number', section: 'systems' },
    { id: 'elecYr',       label: 'Electrical Updated', type: 'number', section: 'systems' },
    ...
    { id: 'fireStationDist',    label: 'Fire Station (mi)',    type: 'number',   section: 'hazards' }, // PDF only — not in HawkSoft FSC
    { id: 'fireHydrantFeet',    label: 'Fire Hydrant (ft)',    type: 'number',   section: 'hazards' }, // PDF only — not in HawkSoft FSC
    { id: 'tidalWaterDist',     label: 'Tidal Water (ft)',     type: 'number',   section: 'hazards' }, // PDF only — not in HawkSoft FSC
    { id: 'protectionClass',    label: 'Protection Class',     type: 'text',     section: 'hazards' },

    // ── Home Coverage ──────────────────────────────────────────────────────
    { id: 'homePolicyType',       label: 'Policy Type',                 type: 'select',   section: 'home-coverage' },
    { id: 'dwellingCoverage',     label: 'Dwelling Coverage',           type: 'text',     section: 'home-coverage' },
    ...
    { id: 'personalLiability',    label: 'Personal Liability',          type: 'text',     section: 'home-coverage' },
    { id: 'medicalPayments',      label: 'Medical Payments',            type: 'text',     section: 'home-coverage' },
    { id: 'homeDeductible',       label: 'Deductible (AOP)',            type: 'text',     section: 'home-coverage' },
    ...
    // ── Home Endorsements ──────────────────────────────────────────────────
    { id: 'increasedReplacementCost', label: 'Increased Replacement Cost', type: 'text',   section: 'home-endorsements' },
    ...
    { id: 'liabilityLimits',   label: 'Liability Limits',       type: 'text',   section: 'auto-coverage' },
    { id: 'pdLimit',           label: 'Property Damage',        type: 'text',   section: 'auto-coverage' },
    { id: 'medPayments',       label: 'Med Pay (Auto)',         type: 'text',   section: 'auto-coverage' },
    { id: 'umLimits',          label: 'UM Limits',              type: 'text',   section: 'auto-coverage' },
    { id: 'uimLimits',         label: 'UIM Limits',             type: 'text',   section: 'auto-coverage' },
    { id: 'umpdLimit',         label: 'UMPD Limit',             type: 'text',   section: 'auto-coverage' },
    { id: 'compDeductible',    label: 'Comprehensive Ded.',     type: 'text',   section: 'auto-coverage' },
    { id: 'autoDeductible',    label: 'Collision Ded.',         type: 'text',   section: 'auto-coverage' },
    { id: 'rentalDeductible',  label: 'Rental Reimbursement',   type: 'text',   section: 'auto-coverage' },
    { id: 'towingDeductible',  label: 'Towing/Roadside',        type: 'text',   section: 'auto-coverage' },
    ...
    { id: 'policyTerm',           label: 'Policy Term',         type: 'select', section: 'prior-insurance' },
    { id: 'effectiveDate',        label: 'Effective Date',      type: 'date',   section: 'prior-insurance' },
    { id: 'priorCarrier',         label: 'Prior Auto Carrier',  type: 'text',   section: 'prior-insurance' },
    { id: 'priorPolicyTerm',      label: 'Prior Auto Term',     type: 'select', section: 'prior-insurance' },
    { id: 'priorYears',           label: 'Prior Auto Years',    type: 'number', section: 'prior-insurance' },
    { id: 'priorExp',             label: 'Prior Auto Exp.',     type: 'date',   section: 'prior-insurance' },
    { id: 'priorLiabilityLimits', label: 'Prior Auto Limits',   type: 'text',   section: 'prior-insurance' },
    { id: 'continuousCoverage',   label: 'Continuous Coverage', type: 'select', section: 'prior-insurance' },
    { id: 'homePriorCarrier',     label: 'Home Prior Carrier',  type: 'text',   section: 'prior-insurance' },
    { id: 'homePriorYears',       label: 'Home Prior Years',    type: 'number', section: 'prior-insurance' },
    { id: 'homePriorPolicyTerm',  label: 'Home Prior Term',     type: 'select', section: 'prior-insurance' }, // PDF only — not in HawkSoft FSC
    { id: 'homePriorExp',         label: 'Home Prior Exp.',     type: 'date',   section: 'prior-insurance' }, // PDF only — not in HawkSoft FSC
