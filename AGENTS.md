...
| **JS** | 109 modules in `js/` (~64,150 lines total) |
...
| **Tests** | Jest + JSDOM, 67 suites, ~2,530 tests |
...
│   └── *.test.js               # 67 suites, ~2,530 tests (Jest + JSDOM)
│
...
8. Test with: npm test (~2,530 tests, 67 suites, all must pass)
...
- [ ] **All tests pass:** `npm test` → 67 suites, ~2,530 tests, 0 failures
