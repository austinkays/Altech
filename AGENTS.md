...
| **Tests** | Jest + JSDOM, 67 suites, ~2,550 tests |
...
│   └── *.test.js               # 67 suites, ~2,550 tests (Jest + JSDOM)
│
...
8. Test with: npm test (~2,550 tests, 67 suites, all must pass)
...
- [ ] **All tests pass:** `npm test` → 67 suites, ~2,550 tests, 0 failures
