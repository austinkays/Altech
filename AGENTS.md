...
| **Tests** | Jest + JSDOM, 72 suites, ~2,600 tests |
...
│   └── *.test.js               # 72 suites, ~2,600 tests (Jest + JSDOM)
│
...
8. Test with: npm test (~2,600 tests, 72 suites, all must pass)
...
- [ ] **All tests pass:** `npm test` → 72 suites, ~2,600 tests, 0 failures
