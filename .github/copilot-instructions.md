...
- Mapping reference: [docs/archive/FIELD_MAPPING_UPDATE.md](https://github.com/austinkays/Altech/blob/main/docs/archive/FIELD_MAPPING_UPDATE.md)
...
See [docs/guides/ENVIRONMENT_SETUP.md](https://github.com/austinkays/Altech/blob/main/docs/guides/ENVIRONMENT_SETUP.md).
...
| **Change workflow order** | [index.html](https://github.com/austinkays/Altech/blob/main/index.html) | Edit `workflows` object; test all 3 qTypes |
| **Add validation** | Export methods | `if (!this.data.field) { alert(...); return; }` |
| **Modify styling** | [index.html](https://github.com/austinkays/Altech/blob/main/index.html) | Use CSS variables (`:root`), no hardcoded colors |
| **Debug data** | DevTools console | `JSON.parse(localStorage.getItem('altech_v6'))` |
| **Field mapping (CMSMTF)** | [docs/archive/FIELD_MAPPING_UPDATE.md](https://github.com/austinkays/Altech/blob/main/docs/archive/FIELD_MAPPING_UPDATE.md) | Maps field → HawkSoft variable |
...
**[.github/copilot-instructions-clean.md](https://github.com/austinkays/Altech/blob/main/.github/copilot-instructions-clean.md)** (comprehensive walkthrough)
