...
> ⚠️ **Status: pre-Phase-A snapshot (2026-04).** This document describes the crypto
> system *before* the Phase A–D hardening (Argon2id KDF, HKDF subkey tree, AAD-bound
> envelopes, RLS audit migration, MigrationBackup safety net) shipped in May 2026.
> Use it as background. For the **current** state, see:
> - [CLAUDE.md](../CLAUDE.md) → "E2E Crypto — four hardened layers" table.
> - [js/crypto-helper.js](../js/crypto-helper.js) — Argon2id + HKDF dispatcher.
> - [js/crypto-aad.js](../js/crypto-aad.js) — AAD builder.
> - [db/migrations/0004_kdf_metadata.sql](../db/migrations/0004_kdf_metadata.sql),
>   [0005_rls_audit.sql](../db/migrations/0005_rls_audit.sql),
>   [0006_harden_function_grants.sql](../db/migrations/0006_harden_function_grants.sql).
